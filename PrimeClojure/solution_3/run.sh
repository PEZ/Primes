...
#clojure -X sieve/run :variant :vector :warm-up? true
#clojure -X sieve/run :variant :vector-transient :warm-up? true
...
#clojure -X sieve/run :variant :boolean-array-avr :warm-up? true
